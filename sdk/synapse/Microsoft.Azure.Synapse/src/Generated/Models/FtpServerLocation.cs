...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    public partial class FtpServerLocation : DatasetLocation
    {
        ...
        /// string (or Expression with resultType string).</param>
        public FtpServerLocation(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), object folderPath = default(object), object fileName = default(object))
