...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    public partial class SalesforceServiceCloudSource : CopySource
    {
        ...
        /// 'QueryAll'</param>
        public SalesforceServiceCloudSource(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object query = default(object), string readBehavior = default(string))
