...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    public partial class SalesforceServiceCloudObjectDataset : Dataset
    {
        ...
        /// SalesforceServiceCloudObjectDataset class.
        /// </summary>
        ...
        /// <param name="objectApiName">The Salesforce Service Cloud object API
        /// name. Type: string (or Expression with resultType string).</param>
        public SalesforceServiceCloudObjectDataset(LinkedServiceReference linkedServiceName, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder), object objectApiName = default(object))
