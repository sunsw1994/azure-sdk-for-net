...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    public partial class MagentoSource : TabularSource
    {
        ...
        public MagentoSource(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object queryTimeout = default(object), object query = default(object))
