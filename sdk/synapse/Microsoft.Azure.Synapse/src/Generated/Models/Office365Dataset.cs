...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    public partial class Office365Dataset : Dataset
    {
        ...
        /// <param name="tableName">Name of the dataset to extract from Office
        /// 365. Type: string (or Expression with resultType string).</param>
        ...
        /// <param name="predicate">A predicate expression that can be used to
        /// filter the specific rows to extract from Office 365. Type: string
        /// (or Expression with resultType string).</param>
        public Office365Dataset(LinkedServiceReference linkedServiceName, object tableName, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder), object predicate = default(object))
