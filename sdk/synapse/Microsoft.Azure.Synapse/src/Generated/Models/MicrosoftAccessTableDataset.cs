...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the MicrosoftAccessTableDataset
        /// class.
        /// </summary>
        ...
        /// <param name="tableName">The Microsoft Access table name. Type:
        /// string (or Expression with resultType string).</param>
        public MicrosoftAccessTableDataset(LinkedServiceReference linkedServiceName, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder), object tableName = default(object))
        ...
        /// <summary>
        /// Gets or sets the Microsoft Access table name. Type: string (or
