...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    public partial class OracleTableDataset : Dataset
    {
        ...
        /// <param name="oracleTableDatasetSchema">The schema name of the
        /// on-premises Oracle database. Type: string (or Expression with
        /// resultType string).</param>
        /// <param name="table">The table name of the on-premises Oracle
        /// database. Type: string (or Expression with resultType
        /// string).</param>
        public OracleTableDataset(LinkedServiceReference linkedServiceName, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder), object tableName = default(object), object oracleTableDatasetSchema = default(object), object table = default(object))
            : base(linkedServiceName, additionalProperties, description, structure, schema, parameters, annotations, folder)
        {
            TableName = tableName;
            OracleTableDatasetSchema = oracleTableDatasetSchema;
            Table = table;
            CustomInit();
        }
