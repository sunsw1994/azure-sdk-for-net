...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    public partial class SftpLocation : DatasetLocation
    {
        ...
        /// string (or Expression with resultType string).</param>
        public SftpLocation(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), object folderPath = default(object), object fileName = default(object))
