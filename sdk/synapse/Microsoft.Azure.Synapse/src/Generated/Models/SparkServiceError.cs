...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the SparkServiceError class.
        /// </summary>
        ...
        public SparkServiceError(string message = default(string), string errorCode = default(string), string source = default(string))
        {
            Message = message;
            ErrorCode = errorCode;
            Source = source;
