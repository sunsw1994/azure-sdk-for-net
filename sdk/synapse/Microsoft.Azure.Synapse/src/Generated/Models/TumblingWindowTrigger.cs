...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    public partial class TumblingWindowTrigger : Trigger
    {
        ...
        public TumblingWindowTrigger(TriggerPipelineReference pipeline, string frequency, int interval, System.DateTimeOffset startTime, int maxConcurrency, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), string runtimeState = default(string), IList<object> annotations = default(IList<object>), System.DateTimeOffset? endTime = default(System.DateTimeOffset?), object delay = default(object), RetryPolicy retryPolicy = default(RetryPolicy), IList<DependencyReference> dependsOn = default(IList<DependencyReference>))
