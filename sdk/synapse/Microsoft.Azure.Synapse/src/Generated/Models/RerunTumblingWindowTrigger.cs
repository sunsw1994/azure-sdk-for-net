...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    public partial class RerunTumblingWindowTrigger : Trigger
    {
        ...
        public RerunTumblingWindowTrigger(System.DateTimeOffset requestedStartTime, System.DateTimeOffset requestedEndTime, int maxConcurrency, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), string runtimeState = default(string), IList<object> annotations = default(IList<object>), object parentTrigger = default(object))
