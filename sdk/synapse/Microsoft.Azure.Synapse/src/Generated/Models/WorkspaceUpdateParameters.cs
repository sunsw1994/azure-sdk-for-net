...
namespace Microsoft.Azure.Synapse.Models
{
    ...
    public partial class WorkspaceUpdateParameters
    {
        ...
        /// workspace.</param>
        public WorkspaceUpdateParameters(IDictionary<string, string> tags = default(IDictionary<string, string>), WorkspaceIdentity identity = default(WorkspaceIdentity))
        {
            Tags = tags;
            Identity = identity;
            CustomInit();
